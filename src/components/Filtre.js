        ...
        <div className="filtre container">
            <div className="d-flex justify-content-between align-items-center my-5 float-end">
                <div>
                    ...
                    <button type="button" className="filtre-refuse btn btn-outline-danger btn me-2">Refuser</button>
                    <button type="button" className="filtre-accepte btn btn-outline-success btn">Valider</button>
                </div>
            </div>
